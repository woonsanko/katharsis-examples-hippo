...
public class TaskToProjectRelationshipRepository extends AbstractRepository
    ...
    @Override
    public Iterable<ProjectResource> findManyTargets(String sourceId, String fieldName, RequestParams requestParams) {
    ...
    @Override
    public ProjectResource findOneTarget(String sourceId, String fieldName, RequestParams requestParams) {
        return null;
    }
